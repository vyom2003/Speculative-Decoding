...
if __name__ == "__main__":
    ...
    for input_sentence in tqdm(test_dl):
        input_prompt = f"Summarize: {input_sentence['article']}"
        output_text, total_time, ops = baseline_decode(input_text=input_prompt, model_name=target_model)
        target_model_bleu_arr.append(calculate_bleu(input_sentence["highlights"][0],output_text))
    ...
    for input_sentence in tqdm(test_dl):
        ...
        small_model_bleu_arr.append(calculate_bleu(input_sentence["highlights"][0],output_text))
    ...
    for input_sentence in tqdm(test_dl):
        ...
        bleu_arr.append(calculate_bleu(input_sentence["highlights"][0],output_text))
